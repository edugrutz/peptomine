...
def run_pipeline(input_dir, output_dir, k_min=21, k_max=25, threads=12, use_kraken=False):
...
if __name__ == "__main__":
    ...
    run_pipeline(args.input, args.output, args.k_min, args.k_max, args.threads, args.kraken)